...
from .views import create_employee,get_employee,delete_inactive_employee,update_employee,log_employee_check_in_v2,log_employee_check_out_v3,get_employee_attendance,get_employee_working_hours_and_status
...
urlpatterns = [
    ...
    path('log_employee_check_in/<str:employee_id>/', log_employee_check_in_v2, name='log_employee_check_in'),
    path('log_employee_check_out/<str:employee_id>/', log_employee_check_out_v3, name='log_employee_check_out'),
